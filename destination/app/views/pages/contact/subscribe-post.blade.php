...
@section('sidebar-menu')
    ...
    <div class="founders">
        ...
        <address>
            <h4>Orange County and San Diego Office Area</h4>
...
@section('content')
    <section style="line-height:30px;">
        ...
        <p>If you would like to know more about our group or our services, please make your initial contact through one of our Co-Founders.</p>
    </section>
